    ...
    <body class="d-flex align-items-center py-4 bg-body-tertiary">
        <main class="form-signin w-100 m-auto">
            ...
            <form id="authentication">
                <h1 class="h3 mb-4 fw-normal">Create a Passkey</h1>
                ...
                <p class="buttonsa">
                    <button type="button" class="btn btn-primary py-2" onclick="passkeyAuthentication()" style="width:100% !important;">Create a Passkey</button>
                </p>
            </form>
