...
<html lang="en" data-bs-theme="auto">
    <head>
        ...
        <style>
            .btn {
                width: calc(27% - 0.5rem) !important;
            }
    ...
    <body class="d-flex align-items-center py-4 bg-body-tertiary">
        <main class="form-signin w-100 m-auto">
            ...
            <form id="authentication">
                <h1 class="h3 mb-4 fw-normal">Confirmation</h1>
                <!-- <div class="form-floating">
                    <input type="text" class="form-control mb-3" id="name">
                    <label for="name">Name</label>
                </div> -->
                <div class="form-floating">
                    <p style="text-align: center;">Are you sure you want to use a password again?</p>
                </div>

                <p class="buttons">
                    <?php
                        $button_passkey = '<button type="button" class="btn btn-primary py-2" onclick="passkeyAuthentication()">No</button>';
                        $button_password = '<button type="button" class="btn btn-primary py-2" onclick="passwordAuthentication()">Yes</button>';
