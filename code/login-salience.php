    ...
    <body class="d-flex align-items-center py-4 bg-body-tertiary">
        <main class="form-signin w-100 m-auto">
            ...
            <form id="authentication">
                ...
                <div class="form-floating">
                    <p style="text-align: center;">Passkeys are a new authentication method</p>
                </div>

                <p class="buttonsa">
                    <button type="button" class="btn btn-primary py-2" onclick="passkeyAuthentication()" style="background-color:#349BE1 !important;border-color:#349BE1 !important;color:#ffffff !important;width:100%;">Use a Passkey</button>
                </p>

                <p class="buttonsa">
                    <button type="button" class="btn btn-primary py-2" onclick="passwordAuthentication()" style="width: 100%; background-color: transparent !important; border: 0 !important; color: #000 !important; min-height: unset;">Keep Using Password</button>
                </p>
            </form>
