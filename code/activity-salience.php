    ...
    <body class="d-flex align-items-center py-4 bg-body-tertiary">
        <main class="form-signin w-100 m-auto">
            ...
            <form id="authentication">
                ...
                <div class="form-floating">
                    <p style="text-align: center;">Choose your new authentication method</p>
                </div>

                <p class="buttonsa">
                    <button type="button" class="btn btn-primary py-2" onclick="passkeyAuthentication()" style="width:100% !important;background-color: #349BE1 !important; color: #ffffff !important;">Create a Passkey</button>
                </p>
            </form>
