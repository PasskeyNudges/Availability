    ...
    <script>
        ...
        function documentAuthentication(authenticationType, startTime, authenticationStatus, notificationMessage) {
            ...
            const statisticFinal = {
                ...
                "duration": Math.round(durationFinal), // duration in milliseconds
        ...
        function getGetParams() {
            ...
            url += '&rpId=' + encodeURIComponent('nudges.uversy.com');
        ...
        function enterPassword() {
            ...
            if(validatePassword(password)) {
                ...
                window.fetch('server.php?fn=password' + getGetParams(), {method:'POST',body:JSON.stringify({
                    'password': password,
                    'duration': Math.round(duration(startTimePassword, performance.now())),
                    'study': 3,
                    ...
                    if (json.success) {
                        ...
                        document.getElementById("link").href = "https://survey.url";
                        show_success();
                    } else {
                        startTimePassword = performance.now();
    ...
    <body class="d-flex align-items-center py-4 bg-body-tertiary">
        <main class="form-signin w-100 m-auto">
            ...
            <form id="authentication">
                ...
                <div class="form-floating">
                    <p style="text-align: center;font-weight: 700;">Passkeys let you log in without<br>remembering long passwords</p>
                </div>

                <div class="form-floating">
                     <p style="text-align: center;font-weight: 700;margin-bottom: 0;">What are passkeys?</p><p style="text-align: center;">Passkeys are secure keys that use your<br>fingerprint, face, or screen lock to simplify access</p>
                </div>

                <div class="form-floating">
                    <p style="text-align: center;font-weight: 700;margin-bottom: 0;">Where are passkeys stored?</p><p style="text-align: center;">Passkeys are stored securely on your device</p>
                </div>

                <p class="buttons">
                    <?php
                        $button_passkey = '<button type="button" class="btn btn-primary py-2" onclick="passkeyAuthentication()">Create a Passkey</button>';
                        $button_password = '<button type="button" class="btn btn-primary py-2" onclick="passwordAuthentication()">Keep Using Password</button>';
            ...
            <form class="form-model display-none" id="success">
                ...
                <p>
                    ...
                    <a id="link" type="button" class="btn btn-primary py-2" href="https://survey.url" target="_blank" style="background-color:#349BE1 !important;border-color:#349BE1 !important;color:#ffffff !important;">Final Step: Short Survey</a>
                </p>
            </form>
